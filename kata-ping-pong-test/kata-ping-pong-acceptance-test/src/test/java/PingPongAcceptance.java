import com.joantolos.kata.pingpong.app.PingPongApp;
...
@TestPropertySource
@SpringBootTest(classes = PingPongApp.class, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
public class PingPongAcceptance implements En {

    private Response response;
    private RequestSpecification request;

    public PingPongAcceptance() {
